...
public final class CommonUtil {
  ...
  public static Boolean isValid(String string) {
    return !(null == string || "".equals(string) || string.trim().equals(""));
  }

  public static String addIfNotNul(String sql, String key, String value) {
    if (value != null && !value.equals("all") && !value.equals("%") && !value.equals("*")) {
      sql += " and " + key + "='" + value + "'";
    }
    return sql;
  }
