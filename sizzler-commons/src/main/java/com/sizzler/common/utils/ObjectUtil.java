...
/**
 * Created by IntelliJ IDEA. User: xiangli Date: 11/07/11 Time: 11:50 AM To
...
public final class ObjectUtil {
  ...
  /**
   * Return whether the given throwable is a checked exception: that is, neither
   ...
   * 
   * @param array
   *          the array to check (may be <code>null</code>, in which case the
   *          return value will always be <code>false</code>)
   * @param element
   ...
   *           values. Use {@link #containsConstant(Enum[], String)} as a guard
   ...
   *         if the object was <code>null</code>
   */
