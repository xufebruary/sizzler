...
public abstract class CollectionUtil {
   ...
   * '<code>source</code> '. If no element in '<code>candidates</code>' is
   * present in '<code>source</code>' returns <code>null</code>. Iteration order
   * is {@link java.util.Collection} implementation specific.
   * 
   * @param source
   *          the source Collection
   * @param candidates
   ...
   * searching the Collection for a value of the first type, then searching for
   ...
   * type. Enumeration elements must be assignable to the type of the given
   * array. The array returned will be a different instance than the array
   * given.
   */
