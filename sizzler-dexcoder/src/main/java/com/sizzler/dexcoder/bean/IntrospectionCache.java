...
public class IntrospectionCache {
  ...
  /** 日志对象 */
  private static final Logger LOG = LoggerFactory.getLogger(IntrospectionCache.class);

  /**
   * Map keyed by class containing IntrospectionCache. Needs to be a WeakHashMap
   * with WeakReferences as values to allow for proper garbage collection in
   * case of multiple class loaders.
   */
