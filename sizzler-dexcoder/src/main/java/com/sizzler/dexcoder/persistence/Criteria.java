...
public class Criteria {
   ...
   * @return
   */
  public Criteria multiplyCondition(Map<String, Object[]> paramMap) {
    Iterator<String> iterator = paramMap.keySet().iterator();
    int i = 1;
    while (iterator.hasNext()) {
      String fieldName = iterator.next();
      Object objects[] = paramMap.get(fieldName);
      if (i == 1) {
        this.isWhere = true;
      }
      AutoField autoField = this.buildAutoFields(fieldName, "and", "=", AutoField.WHERE_FIELD,
          objects);
      this.autoFields.add(autoField);
      i++;
    }
