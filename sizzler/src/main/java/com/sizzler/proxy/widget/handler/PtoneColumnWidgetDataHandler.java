...
@Component
public class PtoneColumnWidgetDataHandler implements
    PtoneGraphWidgetDataHandler<PtoneGraphWidgetDataDesc> {

  private Logger log = LoggerFactory.getLogger(PtoneColumnWidgetDataHandler.class);
