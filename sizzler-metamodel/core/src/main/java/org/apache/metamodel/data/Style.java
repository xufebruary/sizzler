...
/**
 * A {@link Style} represents the visual presentation ('styling') attributes of a value in a
 * {@link Row}. Styling can be used to highlight special values and format the cells of eg. a
 * spreadsheet.
 * <p/>
 * Most datastores don't support styling, but some do. Those who do not support it will just omit
 * it.
 * <p/>
...
public interface Style extends Serializable {
   ...
   * <p/>
   * Creation of {@link Color} objects is handled by the static {@link StyleBuilder}
   * .createColor(...) methods.
   */
