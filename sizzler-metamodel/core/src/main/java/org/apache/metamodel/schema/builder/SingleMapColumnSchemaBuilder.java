...
/**
 * A very simple {@link SchemaBuilder} that builds a schema consisting of 1 table with 1 column, of
 * type {@link Map}.
 */
public class SingleMapColumnSchemaBuilder implements SchemaBuilder, DocumentConverter {
  ...
  public MutableSchema build() {
    ...
    table.addColumn(new MutableColumn(_columnName, ColumnType.MAP, table, 1, null, null, false,
        null, false, null));
