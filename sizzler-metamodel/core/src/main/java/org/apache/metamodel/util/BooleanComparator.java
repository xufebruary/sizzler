...
public final class BooleanComparator implements Comparator<Object> {
  ...
  /**
   * Parses a string and returns a boolean representation of it. To parse the string the following
   * values will be accepted, irrespective of case.
   * <ul>
   * <li>true</li>
   * <li>false</li>
   * <li>1</li>
   ...
   * @return a boolean
   * @throws IllegalArgumentException if the string provided is null or cannot be parsed as a
   *         boolean
   */
  public static boolean parseBoolean(String string) throws IllegalArgumentException {
    ...
    if ("true".equalsIgnoreCase(string) || "1".equals(string) || "y".equalsIgnoreCase(string)
      ...
      return true;
        ...
        || "n".equalsIgnoreCase(string) || "no".equalsIgnoreCase(string)) {
      return false;
    } else {
