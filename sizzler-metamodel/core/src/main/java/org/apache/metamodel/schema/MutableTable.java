...
/**
 * Represents the metadata about a table. Tables reside within a schema and contains columns and
...
public class MutableTable extends AbstractTable implements Serializable {
  ...
  /**
   * Internal getter for the columns of the table. Overwrite this method to implement column lookup,
   * column lazy-loading or similar.
   */
  ...
  /**
   * Internal getter for the relationships of the table. Overwrite this method to implement
   * relationship lookup, relationship lazy-loading or similar.
   */
  ...
  /**
   * Protected method for removing a relationship from this table. Should not be used. Use
   * Relationship.remove() instead.
   */
