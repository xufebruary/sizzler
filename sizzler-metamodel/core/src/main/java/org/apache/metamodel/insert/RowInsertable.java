...
public interface RowInsertable {
   ...
   * @return a builder object on which values can be added and the statement can be committed.
   ...
   */
  public RowInsertionBuilder insertInto(Table table) throws IllegalArgumentException,
      IllegalStateException, UnsupportedOperationException;

  /**
   * Initiates the building of a row insertion operation.
   *
   * @param tableName the name of the table to insert a row into
   * @return a builder object on which values can be added and the statement can be committed.
   * @throws IllegalArgumentException if the tableName argument is null or invalid.
   * @throws IllegalStateException if the connection to the DataContext is read-only or another
   *         access restriction is preventing the operation.
   * @throws UnsupportedOperationException in case {@link #isInsertSupported()} is false
   */
  public RowInsertionBuilder insertInto(String tableName) throws IllegalArgumentException,
      IllegalStateException, UnsupportedOperationException;
   ...
   * @throws UnsupportedOperationException in case {@link #isInsertSupported()} is false
   */
  public RowInsertionBuilder insertInto(String schemaName, String tableName)
