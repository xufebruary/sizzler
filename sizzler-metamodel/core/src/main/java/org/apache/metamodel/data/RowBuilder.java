...
public interface RowBuilder<RB extends RowBuilder<?>> {
  ...
  /**
   * Determines if a column's value has been explicitly specified or not. This can be used to tell
   * explicit NULL values apart from just unspecified values in a statement.
   *
