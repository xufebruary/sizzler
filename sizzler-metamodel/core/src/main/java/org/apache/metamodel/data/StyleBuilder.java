...
public final class StyleBuilder {
   ...
   */
  public StyleBuilder() {
    this(createColor((short) 0, (short) 0, (short) 0), createColor((short) 255, (short) 255,
        (short) 255));
  }

  /**
   * Constructs a new {@link StyleBuilder} with a specified default foreground and background
   * colors. These colors will be disregarded, if posted to the foreground and background methods.
   *
  ...
  /**
   * Resets the state of the built style, which will conceptually match it with
   * {@link Style#NO_STYLE}.
   */
  public void reset() {
    _bold = false;
  ...
  public Style create() {
    StyleImpl style =
        new StyleImpl(_bold, _italic, _underline, _fontSize, _fontSizeUnit, _alignment,
  ...
  /**
   * Creates a Color based on a 6-letter RGB hex color code string, eg. "000000" for black and
   * "FFFFFF" for white.
   *
