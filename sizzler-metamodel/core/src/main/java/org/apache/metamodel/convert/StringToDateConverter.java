...
/**
 * A {@link TypeConverter} that converts String values (on the physical layer) to interpreted
 * {@link Date}s.
 */
public class StringToDateConverter implements TypeConverter<String, Date> {
   ...
   *
   * @param datePattern a String date pattern, corresponding to the syntax of a
