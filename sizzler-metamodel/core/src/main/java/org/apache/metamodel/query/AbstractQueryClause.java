...
/**
 * Represents an abstract clause in a query. Clauses contains IQueryItems and provide basic ways of
 * adding, modifying and removing these.
 *
 * @param <E> the type of query item this QueryClause handles
 * @see Query
 */
public abstract class AbstractQueryClause<E extends QueryItem> extends BaseObject implements
    QueryClause<E> {
