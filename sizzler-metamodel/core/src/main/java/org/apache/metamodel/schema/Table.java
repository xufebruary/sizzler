...
/**
 * Represents a table and it's metadata description. Tables reside within a schema and contains
 * columns and relationships to other tables.
 *
 * @see Schema
 * @see Column
 */
public interface Table extends Comparable<Table>, Serializable, NamedStructure, IdedStructure {
  ...
  /**
   * Gets the columns of this table that are known to be foreign keys (ie. references primary keys
   * in other tables).
   *
