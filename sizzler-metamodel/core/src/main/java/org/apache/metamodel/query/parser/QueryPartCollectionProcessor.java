...
/**
 * Simple implementation of {@link QueryPartProcessor} which simply adds all elements to a
 * collection. Use {@link #getTokens()} to retrieve the 'processed' tokens and {@link #getDelims()}
 * for the corresponding delimitors.
 */
