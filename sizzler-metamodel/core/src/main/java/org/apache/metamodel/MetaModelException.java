 ...
 * <p/>
 * All MetaModelExceptions represent errors discovered withing the MetaModel framework. Typically
 * these will occur if you have put together a query that is not meaningful or if there is a
 * structural problem in a schema.
 */
