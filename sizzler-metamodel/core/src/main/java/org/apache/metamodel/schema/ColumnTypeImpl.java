...
public class ColumnTypeImpl implements ColumnType {
  ...
  public ColumnTypeImpl(String name, SuperColumnType superColumnType, Class<?> javaType,
      boolean largeObject) {
    /*
     * if (name == null) { throw new IllegalArgumentException("Name cannot be null"); } if
     * (superColumnType == null) { throw new
     * IllegalArgumentException("SuperColumnType cannot be null"); }
     */
    _name = name;
  ...
  public static ColumnType convertColumnType(Class<?> cls) {
    ...
    } else if (cls == Character.class || cls == char.class || cls == Character[].class
        || cls == char[].class) {
