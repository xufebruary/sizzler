...
/**
 * Writes Unicode text to an output stream. If the specified encoding is a Unicode, then the text is
 * preceeded by the proper Unicode BOM. If it is any other encoding, this class behaves just like
 * <code>OutputStreamWriter</code>. This class is here because Java's
 * <code>OutputStreamWriter</code> apparently doesn't believe in writing BOMs.
 * <p/>
 * <p/>
...
public class UnicodeWriter extends Writer {
  ...
  public static final byte[] UTF32LE_BOM = new byte[] {(byte) 0xFF, (byte) 0xFE, (byte) 0x00,
      (byte) 0x00};

  public static final byte[] UTF32BE_BOM = new byte[] {(byte) 0x00, (byte) 0x00, (byte) 0xFE,
      (byte) 0xFF};
  ...
  /**
   * This is a utility constructor since the vast majority of the time, this class will be used to
   * write Unicode files.
   *
   ...
   */
  public UnicodeWriter(String fileName, String encoding) throws UnsupportedEncodingException,
      IOException {
  ...
  /**
   * Initializes the internal output stream and writes the BOM if the specified encoding is a
   * Unicode encoding.
   *
