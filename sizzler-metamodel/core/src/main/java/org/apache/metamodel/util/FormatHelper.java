...
public final class FormatHelper {
  ...
  /**
   * Creates a uniform number format which is similar to that of eg. Java doubles. The format will
   * not include thousand separators and it will use a dot as a decimal separator.
   *
   * @return
   */
  ...
  /**
   * Formats a date according to a specific column type (DATE, TIME or TIMESTAMP). For backward
   * compatibility.
   *
   * @param columnType
   * @param date
  ...
  public static Date parseSqlTime(ColumnType columnType, String value) {
    ...
    throw new IllegalArgumentException("String value '" + value + "' not parseable as a "
        + columnType);
  }
