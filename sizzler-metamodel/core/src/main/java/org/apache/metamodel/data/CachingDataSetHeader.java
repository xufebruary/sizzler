...
/**
 * Most common implementation of {@link DataSetHeader}. This implementation is 'caching' in the
 * sense that index values of selectitems are cached in a map to provide quick access when looking
 * up by {@link SelectItem} or {@link Column}.
 */
