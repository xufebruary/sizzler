...
final class InterceptableUpdateScript implements UpdateScript {
  ...
  public InterceptableUpdateScript(InterceptableDataContext interceptableDataContext,
      UpdateScript updateScript, InterceptorList<TableCreationBuilder> tableCreationInterceptors,
  ...
  public void run(UpdateCallback callback) {
    UpdateCallback interceptableUpdateCallback =
        new InterceptableUpdateCallback(_interceptableDataContext, callback,
