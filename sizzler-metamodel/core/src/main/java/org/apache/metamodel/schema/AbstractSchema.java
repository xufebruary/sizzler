...
/**
 * Abstract implementation of the {@link Schema} interface. Implements most common and trivial
 * methods.
 */
public abstract class AbstractSchema implements Schema {
  ...
  public final Table getTableByName(String tableName) {
    ...
    if (logger.isDebugEnabled()) {
      logger.debug("Found {} tables(s) matching '{}': {}", new Object[] {numTables, tableName,
          foundTables});
    }
