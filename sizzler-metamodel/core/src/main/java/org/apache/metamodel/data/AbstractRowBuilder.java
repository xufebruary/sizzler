...
public abstract class AbstractRowBuilder<RB extends RowBuilder<?>> implements RowBuilder<RB> {
  ...
  /**
   * Gets a boolean array indicating if any of the values have been explicitly set to null (as
   * opposed to just not set)
   *
   * @return
   */
  ...
  public final RB value(String columnName, Object value, Style style) {
    ...
    throw new IllegalArgumentException("No such column in table: " + columnName
        + ", available columns are: " + Arrays.toString(_columns));
  }
