...
public interface ColumnType extends HasName, Serializable {
  ...
  public static final ColumnType NCLOB =
      new ColumnTypeImpl("NCLOB", LITERAL_TYPE, Clob.class, true);
  ...
  public static final ColumnType SMALLINT =
      new ColumnTypeImpl("SMALLINT", NUMBER_TYPE, Short.class);
  public static final ColumnType INTEGER =
      new ColumnTypeImpl("INTEGER", NUMBER_TYPE, Integer.class);
  public static final ColumnType BIGINT = new ColumnTypeImpl("BIGINT", NUMBER_TYPE,
      BigInteger.class);
  public static final ColumnType LONG = new ColumnTypeImpl("LONG", NUMBER_TYPE, Long.class);
  ...
  public static final ColumnType DATETIME = new ColumnTypeImpl("DATETIME", TIME_TYPE);
   ...
   * Andy add 2015-12-05
   */
  public static final ColumnType PERCENT = new ColumnTypeImpl("PERCENT", OTHER_TYPE);
  public static final ColumnType CURRENCY = new ColumnTypeImpl("CURRENCY", OTHER_TYPE);
  public static final ColumnType LOCATION_COUNTRY = new ColumnTypeImpl("LOCATION_COUNTRY",
      OTHER_TYPE);
  public static final ColumnType LOCATION_REGION =
      new ColumnTypeImpl("LOCATION_REGION", OTHER_TYPE);
  public static final ColumnType LOCATION_CITY = new ColumnTypeImpl("LOCATION_CITY", OTHER_TYPE);
  public static final ColumnType DURATION = new ColumnTypeImpl("DURATION", OTHER_TYPE);
