...
/**
 * A shared {@link ExecutorService} for use on ad-hoc tasks that can be optimized by running
 * operations in parallel.
 * <p/>
 * Note that since this {@link ExecutorService} is shared, it is not recommended to use it for
 * dedicated tasks or daemon-like long-running tasks.
 */
public final class SharedExecutorService {
  ...
  private static final class ThreadFactoryImpl implements ThreadFactory {
    ...
    public Thread newThread(Runnable r) {
      Thread thread =
          new Thread(_threadGroup, r, "MetaModel.SharedExecutorService.Thread."
