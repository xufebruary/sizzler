...
import org.apache.metamodel.util.UuidUtil;
...
public class HttpClientTool {
  ...
  public static String doGet(String url, Map<String, String> params, boolean encode) {
    return doGet(url, params, defaultChartSet, encode);
  }
  ...
  public static String doPostJsonWithHeader(String url, String jsonEntity,
      Map<String, String> headers) {
    return doPostJson(url, jsonEntity, headers);
  }

  public static String doPostJsonWithoutHeader(String url, String jsonEntity) {
  ...
  public static String doPostJson(String url, String jsonEntity, Map<String, String> headers) {
    if (StringUtil.isBlank(url)) {
      return null;
    }
    HttpPost httpPost = new HttpPost(url);
  ...
  public static void main(String[] args) {
    ...
    params.put("weeks", "1");
    String result =
        HttpClientTool.doGet("http://localhost:5055/console/rest/ptconsole/getUserWeekPreserve",
            params, false);
