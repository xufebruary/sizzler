...
/**
 * Abstract implementation of the {@link RowInsertionBuilder} interface, provided as a convenience
 * to {@link RowInsertable} implementations. Handles all the building operations, but not the commit
 * operation.
 */
