 ...
 */
public interface RowUpdationBuilder extends RowBuilder<RowUpdationBuilder>,
    WhereClauseBuilder<RowUpdationBuilder> {
  ...
  /**
   * Gets a SQL representation of this update operation. Note that the generated SQL is dialect
   * agnostic, so it is not accurately the same as what will be passed to a potential backing
   * database.
   *
  ...
  /**
   * Commits the row updation operation. This operation will overwrite rows in the
   * {@link DataContext}.
   *
