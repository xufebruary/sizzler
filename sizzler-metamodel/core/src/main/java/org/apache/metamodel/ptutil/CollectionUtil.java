...
/**
 * Created with IntelliJ IDEA. User: Administrator Date: 13-11-11 Time: 下午12:24 To change this
...
public abstract class CollectionUtil {
   ...
   * <p>
   * Enforces the given instance to be present, rather than returning <code>true</code> for an equal
   * element as well.
   *
   * @param collection the Collection to check
   * @param element the element to look for
   ...
   * '. If no element in '<code>candidates</code>' is present in '<code>source</code>' returns
   * <code>null</code>. Iteration order is {@link java.util.Collection} implementation specific.
   *
   * @param source the source Collection
   * @param candidates the candidates to search for
   ...
   * @return a value of the given type found if there is a clear match, or <code>null</code> if none
   *         or more than one such value found
   */
  @SuppressWarnings("unchecked")
   ...
   * @return a value of one of the given types found if there is a clear match, or <code>null</code>
   ...
   *
   * @param collection the Collection to check
   * @return <code>true</code> if the collection contains a single reference or multiple references
   *         to the same instance, <code>false</code> else
   */
   ...
   *
   * @param collection the Collection to check
   * @return the common element type, or <code>null</code> if no clear common type has been found
