 ...
 * <p/>
 * In addition to the {@link FilterBuilder}, the WHERE builder allows using {@link QueryParameter}s
 * as operands in the generated filters.
 *
 * @param <B>
 */
public interface WhereBuilder<B extends SatisfiedQueryBuilder<?>> extends
