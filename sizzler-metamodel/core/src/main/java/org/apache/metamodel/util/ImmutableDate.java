...
/**
 * A Date implementation that is immutable and has a predictable (locale-indifferent) toString()
 * method.
 *
...
public final class ImmutableDate extends Date {
  ...
  /**
   * This mutator will throw an {@link UnsupportedOperationException}, since the date is ummutable.
   *
