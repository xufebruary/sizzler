...
/**
 * Parser of query parts. This parser is aware of parenthesis symbols '(' and ')' and only yields
 * tokens that have balanced parentheses. Delimitors are configurable.
 */
public final class QueryPartParser {
  ...
  public void parse() {
    ...
    int offset = 0;
    boolean singleOuterParenthesis =
        _clause.charAt(0) == '(' && _clause.charAt(_clause.length() - 1) == ')';
