...
/**
 * Represents a relationship between two tables where one set of columns is the primary key, and
 * another set is the foreign key.
 *
 * @see Table
 * @see Column
 */
public interface Relationship extends Serializable, Comparable<Relationship> {
   ...
   * @return true if this relation contains the specified primary and foreign columns as a part of
   *         the relation
   */
