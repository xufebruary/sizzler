...
/**
 * Represents the ORDER BY clause of a query containing OrderByItem's. The order and direction of
 * the OrderItems define the way that the result of a query will be sorted.
 *
 * @see OrderByItem
 */
