 ...
 * <p/>
 * An intereptor can touch, modify, enhance or do other operations on certain object types as they
 * are passed around for execution in MetaModel. There are 5 types of concrete interceptors:
 *
...
public interface Interceptor<E> {
   ...
   * @return the intercepted object, or a modification of this if the object is to be replaced by
   *         the interceptor. The returned object must not be null.
   */
