...
final class WhereBuilderImpl extends
    AbstractQueryFilterBuilder<SatisfiedWhereBuilder<GroupedQueryBuilder>> implements
  ...
  public WhereBuilderImpl(Column column, Query query, FilterItem parentOrFilter,
