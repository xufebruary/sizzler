...
/**
 * General purpose comparator to use for objects of various kinds. Prevents NullPointerExceptions
 * and tries to use comparable interface if available and appropriate on incoming objects.
 */
public final class ObjectComparator implements Comparator<Object> {
  ...
  public int compare(final Object o1, final Object o2) {
    ...
    logger
        .debug("Using ToStringComparator because no apparent better comparison method could be found");
