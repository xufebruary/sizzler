...
/**
 * A sequence based on alphabetic representations. Typically a sequence begin with "A", "B", "C"
 * etc. and go from "Z" to "AA", from "AZ" to "BA" etc.
 * <p/>
 * This sequence is practical for generating column names that correspond to column identifiers in
...
public class AlphabeticSequence {
  ...
  /**
   * Creates an alphabetic sequence that will have "A" as it's first value, if iterated using
   * next().
   */
