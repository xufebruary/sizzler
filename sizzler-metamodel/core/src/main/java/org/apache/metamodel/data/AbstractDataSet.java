...
/**
 * Abstract DataSet implementation. Provides convenient implementations of trivial method and
 * reusable parts of non-trivial methods of a DataSet.
 */
public abstract class AbstractDataSet extends BaseObject implements DataSet {
  ...
  /**
   * Constructor appropriate for dataset implementations that wrap other datasets, such as the
   * {@link MaxRowsDataSet}, {@link FilteredDataSet} and more.
   *
   * @param dataSet
   */
