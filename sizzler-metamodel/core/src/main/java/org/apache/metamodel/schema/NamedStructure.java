...
public interface NamedStructure extends HasName {
  ...
  /**
   * Gets a qualified label for later lookup. Typically this qualified label is formatted with a
   * simple dot separator. For example, for a column a typical qualified label would be:
   * "MY_SCHEMA.MY_TABLE.MY_COLUMN".
   * <p/>
   * The qualified label can be used as a unique identifier for the structure but is not necessarily
   * directly transferable to SQL syntax.
   *
