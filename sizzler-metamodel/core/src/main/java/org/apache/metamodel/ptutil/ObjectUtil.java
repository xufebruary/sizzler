...
/**
 * Created by IntelliJ IDEA. User: xiangli Date: 11/07/11 Time: 11:50 AM To change this template use
...
public final class ObjectUtil {
   ...
   *
   * @param enumValues the enum values to check, typically the reports of a call to MyEnum.values()
  ...
  public static <E extends Enum<?>> E caseInsensitiveValueOf(E[] enumValues, String constant) {
    ...
    throw new IllegalArgumentException(String.format(
        "constant [%s] does not exist in enum type %s", constant, enumValues.getClass()
   ...
   * <code>{@link Object#hashCode()}</code>. If the object is an array, this method will delegate to
   * any of the <code>nullSafeHashCode</code> methods for arrays in this class. If the object is
   ...
   * <p>
   * Builds a String representation of the contents in case of an array. Returns <code>"null"</code>
