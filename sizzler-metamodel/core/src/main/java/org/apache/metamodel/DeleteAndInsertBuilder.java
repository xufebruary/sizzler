...
/**
 * Simple implementation of the {@link RowUpdationBuilder} interface, which simply uses a combined
 * delete+insert strategy for performing updates. Note that this implementation is not desirable
 * performance-wise in many cases, but does provide a functional equivalent to a "real" update.
 */
