...
public enum TableType {
  ...
  public static final TableType[] DEFAULT_TABLE_TYPES = new TableType[] {TableType.TABLE,
      TableType.VIEW};
  ...
  /**
   * Tries to resolve a TableType based on an incoming string/literal. If no fitting TableType is
   * found, OTHER will be returned.
   */
