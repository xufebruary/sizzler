...
public abstract class DefaultAggregateFunction<T> implements AggregateFunction {
   ...
   * @return the result of the function execution. The return type class is dependent on the
   *         FunctionType and the values provided. COUNT yields a Long, AVG and SUM yields Double
   *         values and MAX and MIN yields the type of the provided values.
   */
  @Override
