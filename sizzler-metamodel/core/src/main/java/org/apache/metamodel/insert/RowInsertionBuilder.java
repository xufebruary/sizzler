...
public interface RowInsertionBuilder extends RowBuilder<RowInsertionBuilder> {
  ...
  /**
   * Commits the row insertion operation. This operation will write the row to the
   * {@link DataContext}.
   *
  ...
  /**
   * Gets a SQL representation of this insert operation. Note that the generated SQL is dialect
