 ...
 */
public class OperatorTypeImpl implements OperatorType, Serializable {

  /**
     *
     */
  private static final long serialVersionUID = 3024146607915529695L;
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof OperatorType) {
      ...
      return isSpaceDelimited() == other.isSpaceDelimited()
          && Objects.equals(toSql(), other.toSql());
    }
    return false;
  }
  ...
  public static OperatorType convertOperatorType(String sqlType) {
    if (sqlType != null) {
      ...
      switch (sqlType) {
        ...
        case "START_LIKE":
          return OperatorType.START_LIKE;
        case "END_LIKE":
          return OperatorType.END_LIKE;
        case "NOT_START_LIKE":
          return OperatorType.NOT_START_LIKE;
        case "NOT_END_LIKE":
          return OperatorType.NOT_END_LIKE;
      }
    }
    return null;
  }
