...
public final class ImmutableRelationship extends AbstractRelationship implements Serializable {
  ...
  public static void create(Relationship origRelationship, ImmutableSchema schema) {
    ...
    Column[] primaryColumns = getSimilarColumns(origRelationship.getPrimaryColumns(), primaryTable);
    ...
    Column[] foreignColumns = getSimilarColumns(origRelationship.getForeignColumns(), foreignTable);
