...
public interface SchemaBuilder {
  ...
  /**
   * Offers a {@link DocumentSourceProvider} to the {@link SchemaBuilder}. The {@link SchemaBuilder}
   * may consume the sources to build/detect a schema based on the observed documents in the
   * sources. It may also choose to ignore the source, if the it does not need it.
   *
