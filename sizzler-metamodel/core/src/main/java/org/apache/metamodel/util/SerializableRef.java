...
/**
 * A serializable reference to an object which may or may not be serializable. Using this reference
 * there is safety that if the object IS serializable, it will be serialized, or otherwise it will
