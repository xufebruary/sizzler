...
/**
 * Query rewriter for databases that support LIMIT and OFFSET keywords for max rows and first row
 * properties.
 */
public abstract class LimitOffsetQueryRewriter extends DefaultQueryRewriter {
   ...
   * {@inheritDoc}
   * 
   * If the Max rows and/or First row property of the query is set, then we will use the database's
