...
final class ExcelUtils {
  ...
  /**
   * Writes the {@link Workbook} to a {@link Resource}. The {@link Workbook} will be closed as a
  ...
  public static void writeAndCloseWorkbook(ExcelDataContext dataContext, final Workbook wb) {
    ...
    if (wb instanceof HSSFWorkbook && realResource instanceof FileResource
        && realResource.isExists()) {
  ...
  public static Style getCellStyle(Workbook workbook, Cell cell) {
    ...
    if (font instanceof HSSFFont) {
      ...
      throw new IllegalStateException("Unexpected font type: "
          + (font == null ? "null" : font.getClass()) + ")");
    }
    ...
    if (cellStyle.getFillPattern() == 1) {
      ...
      if (color instanceof HSSFColor) {
        ...
        throw new IllegalStateException("Unexpected color type: "
            + (color == null ? "null" : color.getClass()) + ")");
      }
    }
  ...
  public static DataSet getDataSet(Workbook workbook, Sheet sheet, Table table,
