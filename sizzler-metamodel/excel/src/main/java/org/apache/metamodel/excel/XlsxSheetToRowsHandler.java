...
/**
 * XML handler for transforming a sheet into rows. Uses an {@link XlsxRowCallback} to publish
 * identified rows.
 */
final class XlsxSheetToRowsHandler extends DefaultHandler {
  ...
  public XlsxSheetToRowsHandler(XlsxRowCallback callback, XSSFReader xssfReader,
      ExcelConfiguration configuration) throws Exception {
    _callback = callback;
