...
public final class ExcelConfiguration extends BaseObject implements Serializable {
  ...
  /**
   * The line number (1 based) from which to get the names of the columns. Note that this line
   * number is affected by the skipEmptyLines property! If skipEmptyLines is set to true, the line
   * numbers will begin from the first non-empty line.
   * 
  ...
  /**
   * Defines if empty lines in the excel spreadsheet should be skipped while reading the
   * spreadsheet.
   * 
  ...
  /**
   * Defines if empty columns in the excel spreadsheet should be skipped while reading the
   * spreadsheet.
   * 
  ...
  public String toString() {
    return "ExcelConfiguration[columnNameLineNumber=" + columnNameLineNumber + ", skipEmptyLines="
        + skipEmptyLines + ", skipEmptyColumns=" + skipEmptyColumns + "]";
  }
}
