...
/**
 * This class is an adaptation of the CSVWriter class of OpenCSV. We've made the writer work without
 * having the output stream as state (suiting for {@link Resource} usage).
 */
