...
final class SingleLineCsvRow extends AbstractRow {
  ...
  public SingleLineCsvRow(SingleLineCsvDataSet dataSet, final String line,
      final int columnsInTable, final boolean failOnInconsistentRowLength, final int rowNumber) {
    _dataSet = dataSet;
    _line = line;
    ...
    if (_values == null) {
      ...
      if (_failOnInconsistentRowLength) {
        if (_columnsInTable != csvValues.length) {
          throw new InconsistentRowLengthException(_columnsInTable, SingleLineCsvRow.this,
